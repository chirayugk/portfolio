...
export const portfolioData: PortfolioData = {
  seo: {
    ...
    ogImage: "/images/placehold er.png",
      ...
      projects: [
        {
          ...
          title: "TECHPULSE",
          description:
            "AI Technews searching platform with ai summarizer.",
          techStack: ["Python", "OpenAI", "Next.js", "FastAPI", "PostgreSQL", ""],
          liveUrl: "https://hackernews-clone-frontend-deploy.vercel.app/",
          githubUrl: "https://github.com/chirayugk/hackernews-clone-frontend",
        },
        {
          image: "/images/videosummary.png",
          title: "Video Intelligence Platform ",
          description:
            "AI-powered platform that enables users to upload videos, generate summaries, and interact with content through a RAG based chatbot",
          techStack: ["Next.js", "OpenAI","FastAPI","WhisperAPI", "Redis", "PostgreSQL"],
          liveUrl: "LIVE_URL",
        ...
        },
        {
          ...
          description:
            "CNN-based Face Shape Detection and Hairstyle Recommendation System",
          techStack: ["Python", "TensorFlow", "OpenCV"],
          liveUrl: "NA",
          githubUrl: "https://github.com/chirayugk/Hairstyle-Recommending-System-using-face-shape",
        },
        {
